...
=============================================================================
Purpose:
	- This report consolidates key product metics and behaviors
...
WHERE order_date IS NOT NULL -- Only condider valid sales dates
),
...
SELECT
	...
	-- Compuate Average Order Revenue (AVO)
